...
# Full component list from PCB generator + relay drivers/sensors
# COMPONENTS was imported from components_gen above
# Here we extend it with relay driver loops that weren't in the static list
# (RELAY1-8, Q_R1-8, R_GR1-8, D_FLY1-8 are in components_gen.py via gen_pcb_v2.py)

# Add relay drivers and sensors
for i, y in enumerate([93, 110, 127, 144]):
    COMPONENTS += [
        (f"Q_R{i+1}", "S8050", 148, y, [
            (1, -0.5, -0.95, 0.6, 0.9, 0, "rect", f"RELAY{i+1}_DRV"),
            (2, -0.5, 0.95, 0.6, 0.9, 0, "rect", "GND_STAR"),
            (3, 0.5, 0, 0.6, 0.9, 0, "rect", f"COIL{i+1}"),
        ]),
        (f"R_GR{i+1}", "100R", 155, y, [
            (1, -0.5, 0, 0.8, 0.5, 0, "rect", f"RELAY{i+1}_DRV"),
            (2, 0.5, 0, 0.8, 0.5, 0, "rect", f"RELAY{i+1}_DRV"),
        ]),
        (f"D_FLY{i+1}", "1N4148", 167, y, [
            (1, -0.7, 0, 0.8, 0.5, 0, "rect", "+5V_RELAY_RAW"),
            (2, 0.7, 0, 0.8, 0.5, 0, "rect", f"COIL{i+1}"),
        ]),
        (f"R_PD_R{i+1}", "100k", 140, y, [
            (1, -0.5, 0, 0.8, 0.5, 0, "rect", f"RELAY{i+1}_DRV"),
            (2, 0.5, 0, 0.8, 0.5, 0, "rect", "GND_STAR"),
        ]),
        (f"RELAY{i+1}", "SRD-05VDC-SL-C", 175, y, [
            (1, -3.81, -2.54, 1.0, 1.0, 1.0, "oval", f"COIL{i+1}"),
            (2, -3.81, 2.54, 1.0, 1.0, 1.0, "oval", f"COM{i+1}"),
            (3, 3.81, -2.54, 1.0, 1.0, 1.0, "oval", f"NO{i+1}"),
            (4, 3.81, 2.54, 1.0, 1.0, 1.0, "oval", f"NC{i+1}"),
            (5, 0, -2.54, 1.0, 1.0, 1.0, "oval", f"COIL{i+1}N"),
        ]),
        (f"J_R{i+1}", "3P 7.62mm", 185, y, [
            (1, -7.62, -2.54, 1.2, 1.2, 1.2, "oval", f"COM{i+1}"),
            (2, 0, -2.54, 1.2, 1.2, 1.2, "oval", f"NO{i+1}"),
            (3, 7.62, -2.54, 1.2, 1.2, 1.2, "oval", f"NC{i+1}"),
        ]),
    ]
...
COMPONENTS += [
    ("D_RELAY_PWR_GOOD", "BAT54S", 45, 93, [
        (1, -0.5, -0.95, 0.6, 0.9, 0, "rect", "NET_RELAY_INTERLOCK"),
        (2, -0.5, 0.95, 0.6, 0.9, 0, "rect", "NET_RELAY_INTERLOCK"),
        (3, 0.5, 0, 0.6, 0.9, 0, "rect", "RELAY_EN"),
    ]),
    ("D_RELAY_BOOT_OK", "BAT54S", 55, 93, [
        (1, -0.5, -0.95, 0.6, 0.9, 0, "rect", "NET_RELAY_INTERLOCK"),
        (2, -0.5, 0.95, 0.6, 0.9, 0, "rect", "NET_RELAY_INTERLOCK"),
        (3, 0.5, 0, 0.6, 0.9, 0, "rect", "BOOT_OK"),
    ]),
    ("R_RELAY_EN_PU", "10k", 65, 93, [
        (1, -0.5, 0, 0.8, 0.5, 0, "rect", "RELAY_EN"),
        (2, 0.5, 0, 0.8, 0.5, 0, "rect", "+3V3_ESP"),
    ]),
...
COMPONENTS += [
    ("J_DHT", "CONN_3.81_3P", 40, 35, [
        (1, -3.81, 0, 0.7, 0.7, 0.7, "oval", "+3V3_ANA"),
        (2, 0, 0, 0.7, 0.7, 0.7, "oval", "GND_STAR"),
        (3, 3.81, 0, 0.7, 0.7, 0.7, "oval", "DHT22_RAW"),
    ]),
    ("R_DHT_PU", "4.7k", 48, 38, [
        (1, -0.5, 0, 0.8, 0.5, 0, "rect", "+3V3_ANA"),
        (2, 0.5, 0, 0.8, 0.5, 0, "rect", "DHT22_RAW"),
    ]),
    ("D_DHT_ESD", "SMBJ5.0A", 55, 40, [
        (1, -0.7, 0, 0.8, 0.5, 0, "rect", "DHT22_RAW"),
        (2, 0.7, 0, 0.8, 0.5, 0, "rect", "GND_STAR"),
    ]),
    ("J_DS", "CONN_3.81_3P", 40, 45, [
        (1, -3.81, 0, 0.7, 0.7, 0.7, "oval", "+3V3_ANA"),
        (2, 0, 0, 0.7, 0.7, 0.7, "oval", "GND_STAR"),
        (3, 3.81, 0, 0.7, 0.7, 0.7, "oval", "DS18B20_RAW"),
    ]),
    ("R_DS_PU", "4.7k", 48, 48, [
        (1, -0.5, 0, 0.8, 0.5, 0, "rect", "+3V3_ANA"),
        (2, 0.5, 0, 0.8, 0.5, 0, "rect", "DS18B20_RAW"),
    ]),
    ("D_DS_ESD", "SMBJ5.0A", 55, 50, [
        (1, -0.7, 0, 0.8, 0.5, 0, "rect", "DS18B20_RAW"),
        (2, 0.7, 0, 0.8, 0.5, 0, "rect", "GND_STAR"),
    ]),
    ("J_SOIL", "CONN_3.81_3P", 40, 55, [
        (1, -3.81, 0, 0.7, 0.7, 0.7, "oval", "+3V3_ANA"),
        (2, 0, 0, 0.7, 0.7, 0.7, "oval", "GND_STAR"),
        (3, 3.81, 0, 0.7, 0.7, 0.7, "oval", "SOIL_RAW"),
    ]),
    ("R_SOIL_SER", "1k", 35, 55, [
        (1, -0.5, 0, 0.8, 0.5, 0, "rect", "SOIL_RAW"),
        (2, 0.5, 0, 0.8, 0.5, 0, "rect", "NET_SOIL_SER"),
    ]),
    ("C_SOIL", "100nF", 32, 55, [
        (1, -0.5, 0, 0.8, 0.5, 0, "rect", "NET_SOIL_SER"),
        (2, 0.5, 0, 0.8, 0.5, 0, "rect", "GND_STAR"),
    ]),
    ("D_SOIL_ESD", "SMBJ5.0A", 29, 55, [
        (1, -0.7, 0, 0.8, 0.5, 0, "rect", "NET_SOIL_SER"),
        (2, 0.7, 0, 0.8, 0.5, 0, "rect", "GND_STAR"),
    ]),

    # VIN sense
    ("J_VBAT", "CONN_5.08_2P", 190, 28, [
        (1, 0, -2.54, 1.6, 1.6, 1.0, "oval", "+12V_PROTECTED"),
        (2, 0, 2.54, 1.6, 1.6, 1.0, "oval", "GND_STAR"),
    ]),
    ("R_VTOP", "100k 1%", 178, 28, [
        (1, -0.5, 0, 0.8, 0.5, 0, "rect", "+12V_PROTECTED"),
        (2, 0.5, 0, 0.8, 0.5, 0, "rect", "NET_VIN_DIV"),
    ]),
    ("R_VBOT", "33k 1%", 175, 25, [
        (1, -0.5, 0, 0.8, 0.5, 0, "rect", "NET_VIN_DIV"),
        (2, 0.5, 0, 0.8, 0.5, 0, "rect", "GND_STAR"),
    ]),
    ...
    ("R_VSENSE_SER_B", "1k", 173, 28, [
        (1, -0.5, 0, 0.8, 0.5, 0, "rect", "NET_VIN_DIV"),
        (2, 0.5, 0, 0.8, 0.5, 0, "rect", "VIN_SENSE_RAW"),
    ]),
    ("D_VSENSE_CLAMP", "BAT54S", 170, 28, [
        (1, -0.5, -0.95, 0.6, 0.9, 0, "rect", "VIN_SENSE_RAW"),
        (2, -0.5, 0.95, 0.6, 0.9, 0, "rect", "VIN_SENSE_RAW"),
        (3, 0.5, 0, 0.6, 0.9, 0, "rect", "+3V3_ESP"),
    ]),

    # ADS1115
    ("U_ADS", "ADS1115IDGSR", 82, 53, [
        (1, -1.95, -1.5, 0.3, 0.6, 0, "rect", "+3V3_ANA"),
        (2, -1.95, -0.5, 0.3, 0.6, 0, "rect", "GND_STAR"),
        (3, -1.95, 0.5, 0.3, 0.6, 0, "rect", "I2C_SCL"),
        (4, -1.95, 1.5, 0.3, 0.6, 0, "rect", "I2C_SDA"),
        (5, 1.95, -1.5, 0.3, 0.6, 0, "rect", "ADS_A0"),
        (6, 1.95, -0.5, 0.3, 0.6, 0, "rect", "ADS_A1"),
        (7, 1.95, 0.5, 0.3, 0.6, 0, "rect", "ADS_A2"),
        (8, 1.95, 1.5, 0.3, 0.6, 0, "rect", "ADS_A3"),
    ]),
...
# ADS analog input series + TVS
for i, (x, net) in enumerate([(75, "ADS_A0"), (78, "ADS_A1"), (81, "ADS_A2"), (84, "ADS_A3")]):
    COMPONENTS += [
        (f"R_A{i}_SER", "1k", x, 48, [
            (1, -0.5, 0, 0.8, 0.5, 0, "rect", f"NET_A{i}"),
            (2, 0.5, 0, 0.8, 0.5, 0, "rect", net),
        ]),
        (f"D_A{i}_ESD", "SMBJ5.0A", x+3, 48, [
            (1, -0.7, 0, 0.8, 0.5, 0, "rect", f"NET_A{i}"),
            (2, 0.7, 0, 0.8, 0.5, 0, "rect", "GND_STAR"),
        ]),
    ]
...
COMPONENTS += [
    ("J_AIN", "CONN_3.81_6P", 112.5, 60, [
        (1, -12.7, 0, 0.7, 0.7, 0.7, "oval", "NET_PH_RAW"),
        (2, -8.89, 0, 0.7, 0.7, 0.7, "oval", "NET_TDS_RAW"),
        (3, -5.08, 0, 0.7, 0.7, 0.7, "oval", "NET_DO_RAW"),
        (4, -1.27, 0, 0.7, 0.7, 0.7, "oval", "GND_STAR"),
        (5, 2.54, 0, 0.7, 0.7, 0.7, "oval", "GND_STAR"),
        (6, 6.35, 0, 0.7, 0.7, 0.7, "oval", "GND_STAR"),
    ]),

    # I2C bus
    ("J_I2C_EXT", "CONN_3.81_4P", 35, 23, [
        (1, -5.71, 0, 0.7, 0.7, 0.7, "oval", "+3V3_ESP"),
        (2, -1.9, 0, 0.7, 0.7, 0.7, "oval", "I2C_SCL"),
        (3, 1.9, 0, 0.7, 0.7, 0.7, "oval", "I2C_SDA"),
        (4, 5.71, 0, 0.7, 0.7, 0.7, "oval", "GND_STAR"),
    ]),
    ("J_DEBUG", "CONN_3.81_4P", 35, 25, [
        (1, -5.71, 0, 0.7, 0.7, 0.7, "oval", "+3V3_ESP"),
        (2, -1.9, 0, 0.7, 0.7, 0.7, "oval", "UART0_TX"),
        (3, 1.9, 0, 0.7, 0.7, 0.7, "oval", "UART0_RX"),
        (4, 5.71, 0, 0.7, 0.7, 0.7, "oval", "GND_STAR"),
    ]),
    ("R_I2C_PU_SCL", "4.7k", 60, 43, [
        (1, -0.5, 0, 0.8, 0.5, 0, "rect", "I2C_SCL"),
        (2, 0.5, 0, 0.8, 0.5, 0, "rect", "+3V3_ANA"),
    ]),
    ("R_I2C_PU_SDA", "4.7k", 60, 48, [
        (1, -0.5, 0, 0.8, 0.5, 0, "rect", "I2C_SDA"),
        (2, 0.5, 0, 0.8, 0.5, 0, "rect", "+3V3_ANA"),
    ]),
    ("R_I2C_SCL_SER", "22R", 48, 43, [
        (1, -0.5, 0, 0.8, 0.5, 0, "rect", "I2C_SCL"),
        (2, 0.5, 0, 0.8, 0.5, 0, "rect", "I2C_SCL"),
    ]),
    ("R_I2C_SDA_SER", "22R", 48, 48, [
        (1, -0.5, 0, 0.8, 0.5, 0, "rect", "I2C_SDA"),
        (2, 0.5, 0, 0.8, 0.5, 0, "rect", "I2C_SDA"),
    ]),
    ("D_I2C_SCL_ESD", "SMBJ5.0A", 43, 43, [
        (1, -0.7, 0, 0.8, 0.5, 0, "rect", "I2C_SCL"),
        (2, 0.7, 0, 0.8, 0.5, 0, "rect", "GND_STAR"),
    ]),
    ("D_I2C_SDA_ESD", "SMBJ5.0A", 43, 48, [
        (1, -0.7, 0, 0.8, 0.5, 0, "rect", "I2C_SDA"),
        (2, 0.7, 0, 0.8, 0.5, 0, "rect", "GND_STAR"),
    ]),
    ("U_BME280", "BME280", 127.5, 55, [
        (1, -2.0, -1.5, 0.3, 0.5, 0, "rect", "+3V3_ESP"),
        (2, -2.0, -0.5, 0.3, 0.5, 0, "rect", "GND_STAR"),
        (3, -2.0, 0.5, 0.3, 0.5, 0, "rect", "I2C_SCL"),
        (4, -2.0, 1.5, 0.3, 0.5, 0, "rect", "I2C_SDA"),
        (5, 2.0, -1.5, 0.3, 0.5, 0, "rect", "NC"),
        (6, 2.0, -0.5, 0.3, 0.5, 0, "rect", "NC"),
        (7, 2.0, 0.5, 0.3, 0.5, 0, "rect", "NC"),
        (8, 2.0, 1.5, 0.3, 0.5, 0, "rect", "NC"),
    ]),
    ("U_OLED", "OLED 0.96", 145, 55, [
        (1, -3.81, -1.27, 0.3, 0.5, 0, "rect", "+3V3_ESP"),
        (2, -3.81, 0, 0.3, 0.5, 0, "rect", "GND_STAR"),
        (3, -3.81, 1.27, 0.3, 0.5, 0, "rect", "I2C_SCL"),
        (4, 3.81, -1.27, 0.3, 0.5, 0, "rect", "I2C_SDA"),
        (5, 3.81, 0, 0.3, 0.5, 0, "rect", "NC"),
        (6, 3.81, 1.27, 0.3, 0.5, 0, "rect", "NC"),
    ]),

    # MicroSD
    ("U_SDCARD", "MicroSD Socket", 140, 80, [
        (1, -5.0, -3.5, 0.6, 0.6, 0.6, "oval", "SD_MISO"),
        (2, -2.5, -3.5, 0.6, 0.6, 0.6, "oval", "SD_MOSI"),
        (3, 0, -3.5, 0.6, 0.6, 0.6, "oval", "GND_STAR"),
        (4, 2.5, -3.5, 0.6, 0.6, 0.6, "oval", "SD_SCK"),
        (5, 5.0, -3.5, 0.6, 0.6, 0.6, "oval", "SD_CS"),
        (6, -5.0, 0, 0.6, 0.6, 0.6, "oval", "NC"),
        (7, 5.0, 0, 0.6, 0.6, 0.6, "oval", "NC"),
        (8, -5.0, 3.5, 1.2, 0.8, 0, "rect", "+3V3_ESP"),
        (9, 5.0, 3.5, 1.2, 0.8, 0, "rect", "NC"),
    ]),
    ("R_SD_SCK", "22R", 134, 83, [
        (1, -0.5, 0, 0.8, 0.5, 0, "rect", "SD_SCK"),
        (2, 0.5, 0, 0.8, 0.5, 0, "rect", "SD_SCK"),
    ]),
    ("R_SD_MOSI", "22R", 134, 80, [
        (1, -0.5, 0, 0.8, 0.5, 0, "rect", "SD_MOSI"),
        (2, 0.5, 0, 0.8, 0.5, 0, "rect", "SD_MOSI"),
    ]),
    ("R_SD_MISO", "22R", 134, 77, [
        (1, -0.5, 0, 0.8, 0.5, 0, "rect", "SD_MISO"),
        (2, 0.5, 0, 0.8, 0.5, 0, "rect", "SD_MISO"),
    ]),
    ("R_SD_CS", "10k", 134, 74, [
        (1, -0.5, 0, 0.8, 0.5, 0, "rect", "SD_CS"),
        (2, 0.5, 0, 0.8, 0.5, 0, "rect", "+3V3_ESP"),
    ]),
    ("R_SD_DET_PU", "10k", 134, 71, [
        (1, -0.5, 0, 0.8, 0.5, 0, "rect", "SD_DET"),
        (2, 0.5, 0, 0.8, 0.5, 0, "rect", "+3V3_ESP"),
    ]),
    ("C_SD_DEC", "100nF", 137, 83, [
        (1, -0.5, 0, 0.8, 0.5, 0, "rect", "+3V3_ESP"),
        (2, 0.5, 0, 0.8, 0.5, 0, "rect", "GND_STAR"),
    ]),

    # IO Expanders
    ("U_EXP1", "MCP23017T-E", 50, 110, [
        (1, -3.2, -2.8, 0.3, 0.6, 0, "rect", "+3V3_ESP"),
        (2, -3.2, -2.1, 0.3, 0.6, 0, "rect", "GND_STAR"),
        (3, -3.2, -1.4, 0.3, 0.6, 0, "rect", "I2C_SCL"),
        (4, -3.2, -0.7, 0.3, 0.6, 0, "rect", "I2C_SDA"),
        (5, -3.2, 0, 0.3, 0.6, 0, "rect", "EXP1_RESET"),
        (6, -3.2, 0.7, 0.3, 0.6, 0, "rect", "EXP1_INTA"),
        (7, -3.2, 1.4, 0.3, 0.6, 0, "rect", "EXP1_INTB"),
        (8, -3.2, 2.1, 0.3, 0.6, 0, "rect", "NC"),
        (9, 3.2, -2.8, 0.3, 0.6, 0, "rect", "EXP1_GPIO0"),
        (10, 3.2, -2.1, 0.3, 0.6, 0, "rect", "EXP1_GPIO1"),
        (11, 3.2, -1.4, 0.3, 0.6, 0, "rect", "EXP1_GPIO2"),
        (12, 3.2, -0.7, 0.3, 0.6, 0, "rect", "EXP1_GPIO3"),
        (13, 3.2, 0, 0.3, 0.6, 0, "rect", "EXP1_GPIO4"),
        (14, 3.2, 0.7, 0.3, 0.6, 0, "rect", "EXP1_GPIO5"),
        (15, 3.2, 1.4, 0.3, 0.6, 0, "rect", "EXP1_GPIO6"),
        (16, 3.2, 2.1, 0.3, 0.6, 0, "rect", "EXP1_GPIO7"),
    ]),
    ("U_EXP2", "MCP23017T-E", 50, 125, [
        ...
        (3, -3.2, -1.4, 0.3, 0.6, 0, "rect", "I2C_SCL"),
        (4, -3.2, -0.7, 0.3, 0.6, 0, "rect", "I2C_SDA"),
        (5, -3.2, 0, 0.3, 0.6, 0, "rect", "+3V3_ESP"),
        (6, -3.2, 0.7, 0.3, 0.6, 0, "rect", "EXP2_INTA"),
        (7, -3.2, 1.4, 0.3, 0.6, 0, "rect", "EXP2_INTB"),
        (8, -3.2, 2.1, 0.3, 0.6, 0, "rect", "NC"),
        (9, 3.2, -2.8, 0.3, 0.6, 0, "rect", "EXP2_GPIO0"),
        (10, 3.2, -2.1, 0.3, 0.6, 0, "rect", "EXP2_GPIO1"),
        (11, 3.2, -1.4, 0.3, 0.6, 0, "rect", "EXP2_GPIO2"),
        (12, 3.2, -0.7, 0.3, 0.6, 0, "rect", "EXP2_GPIO3"),
        (13, 3.2, 0, 0.3, 0.6, 0, "rect", "EXP2_GPIO4"),
        (14, 3.2, 0.7, 0.3, 0.6, 0, "rect", "EXP2_GPIO5"),
        (15, 3.2, 1.4, 0.3, 0.6, 0, "rect", "EXP2_GPIO6"),
        (16, 3.2, 2.1, 0.3, 0.6, 0, "rect", "EXP2_GPIO7"),
    ]),
]

# Expansion relays 5-8
for i, y in enumerate([93, 110, 127, 144]):
    COMPONENTS += [
        (f"Q_R{i+5}", "S8050", 62, y, [
            (1, -0.5, -0.95, 0.6, 0.9, 0, "rect", f"EXP1_GPIO{i}"),
            (2, -0.5, 0.95, 0.6, 0.9, 0, "rect", "GND_STAR"),
            (3, 0.5, 0, 0.6, 0.9, 0, "rect", f"COIL{i+5}"),
        ]),
        (f"R_GR{i+5}", "100R", 55, y, [
            (1, -0.5, 0, 0.8, 0.5, 0, "rect", f"EXP1_GPIO{i}"),
            (2, 0.5, 0, 0.8, 0.5, 0, "rect", f"EXP1_GPIO{i}"),
        ]),
        (f"D_FLY{i+5}", "1N4148", 48, y, [
            (1, -0.7, 0, 0.8, 0.5, 0, "rect", "+5V_RELAY_RAW"),
            (2, 0.7, 0, 0.8, 0.5, 0, "rect", f"COIL{i+5}"),
        ]),
    ]
...
COMPONENTS += [
    ("J_PWR_EXT", "CONN_7.62_2P", 190, 20, [
        (1, -3.81, 0, 1.2, 1.2, 1.2, "oval", "+12V_PROTECTED"),
        (2, 3.81, 0, 1.2, 1.2, 1.2, "oval", "GND_STAR"),
    ]),
    ("J_EXP_HEADER", "CONN_5.08_2x5", 90, 42.5, [
        (1, -2.54, 5.08, 0.8, 0.8, 0.8, "oval", "+3V3_ESP"),
        (2, 0, 5.08, 0.8, 0.8, 0.8, "oval", "GND_STAR"),
        (3, 2.54, 5.08, 0.8, 0.8, 0.8, "oval", "EXP1_GPIO4"),
        (4, -2.54, 2.54, 0.8, 0.8, 0.8, "oval", "EXP1_GPIO5"),
        (5, 0, 2.54, 0.8, 0.8, 0.8, "oval", "EXP1_GPIO6"),
        (6, 2.54, 2.54, 0.8, 0.8, 0.8, "oval", "EXP1_GPIO7"),
        (7, -2.54, 0, 0.8, 0.8, 0.8, "oval", "EXP2_GPIOB0"),
        (8, 0, 0, 0.8, 0.8, 0.8, "oval", "EXP2_GPIOB1"),
        (9, 2.54, 0, 0.8, 0.8, 0.8, "oval", "EXP2_GPIOB2"),
        (10, -2.54, -2.54, 0.8, 0.8, 0.8, "oval", "EXP2_GPIOB3"),
        (11, 0, -2.54, 0.8, 0.8, 0.8, "oval", "NC"),
        (12, 2.54, -2.54, 0.8, 0.8, 0.8, "oval", "NC"),
    ]),
]

# Test points
tps = [
    ("TP_12VPROT", "+12V_PROTECTED", 5, 0),
    ("TP_5VSYS", "+5V_SYS", 8, 0),
    ("TP_3V3ESP", "+3V3_ESP", 11, 0),
    ("TP_3V3ANA", "+3V3_ANA", 14, 0),
    ("TP_GND", "GND_STAR", 17, 0),
    ("TP_UART_TX", "UART0_TX", 20, 0),
    ("TP_UART_RX", "UART0_RX", 23, 0),
    ("TP_EN", "EN_ESP", 26, 0),
    ("TP_BOOT", "BOOT_ESP", 29, 0),
    ("TP_I2C_SCL", "I2C_SCL", 32, 0),
    ("TP_I2C_SDA", "I2C_SDA", 35, 0),
    ("TP_WD", "WATCHDOG_KICK", 38, 0),
    ("TP_PWRGOOD", "POWER_GOOD", 41, 0),
    ("TP_RELAY_EN", "RELAY_EN", 44, 0),
    ("TP_BOOT_OK", "BOOT_OK", 47, 0),
    ("TP_WD_RST", "WATCHDOG_RST", 50, 0),
]
for ref, net, x, y in tps:
    COMPONENTS.append((ref, net, x, y, [
        (1, 0, 0, 1.0, 1.0, 0, "circle", net),
    ]))

# Mounting holes
for mx, my in [(5, 5), (5, 145), (195, 5), (195, 145)]:
    COMPONENTS.append((f"MH_{mx}_{my}", "M3_Hole", mx, my, [
        (1, 0, 0, 5.0, 5.0, 3.2, "circle", "NPTH"),
    ]))

# Thermal vias under MP1584
for tx, ty in [(68, 38), (68, 35), (68, 32), (76, 38), (76, 35), (76, 32),
                (108, 38), (108, 35), (108, 32), (116, 38), (116, 35), (116, 32)]:
    COMPONENTS.append((f"TV_{tx}_{ty}", "ThermalVia", tx, ty, [
        (1, 0, 0, 0.6, 0.6, 0.3, "circle", "GND_STAR"),
    ]))

# GND stitching vias (every 10mm grid)
